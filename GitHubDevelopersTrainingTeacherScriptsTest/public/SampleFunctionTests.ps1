...
function GitHubDevelopersTrainingTeacherScriptsTest_GetPublicString{ 
...
function GitHubDevelopersTrainingTeacherScriptsTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "GitHubDevelopersTrainingTeacherScripts.psd1"
...
Export-ModuleMember -Function GitHubDevelopersTrainingTeacherScriptsTest_*
